...
const RED_MODELS = ['Red-Qwen3.8-27B-PARO-INT5', 'Red-Qwen3.8-27B-MXFP4', 'Red-Qwen3.8-Flash-Next-MXFP4'] as const
        ...
        return <section key={slug} aria-label={modelName(slug)} className="rounded-sm border border-line p-3">
          <Cluster>
            <div className="min-w-0 flex-1">
              ...
              <Text>{slug === 'Red-Qwen3.8-27B-PARO-INT5' ? 'Red default · 27B int5 · 256K context · up to 8 requests' : slug === 'Red-Qwen3.8-27B-MXFP4' ? '27B MXFP4 · 256K context · up to 8 requests' : 'Flash Next · 256K context · 1 request'}</Text>
            </div>
