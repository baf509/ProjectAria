...
REGISTRY: tuple[ModelServerSpec, ...] = (
    ...
    ModelServerSpec(
        ...
        description="Engineering-only reproduction of ucicelos/flashnext-hybrid on RTX 3090 CUDA "
        "plus Strix Halo RADV Vulkan. Unmodified author launcher: CUDA dense trunk/KV/Q4 MTP3, "
        "Halo experts, disk PLE, q8 K/V, Sharp template, 8 GiB prompt cache and 32 checkpoints. "
        "196608 total tokens: one 196608-token slot or four 49152-token slots, as reported by "
        "the active profile. Docker adapts the author's Toolbox environment. "
        "No local engine patches; performance and correctness are not yet qualified.",
