...
SEED_ENTITIES: tuple[SeedEntity, ...] = (
    ...
    },
    {
        ...
        "type": "machine",
        "name": "red",
        "summary": "Dual-boot inference PC: Ubuntu 26.04.1 on the 2 TB Lexar, Windows 11 on the separate 4 TB Samsung. Two Radeon AI PRO R9700s serve Qwen3.8-27B Radiance through Aria; explicit sleep/wake through Corsair's LAN relay.",
        "aliases": ["Red PC", "red-linux", "red-linux.tailb286a5.ts.net"],
        "tags": ["linux", "windows", "dual-boot", "gpu", "inference", "sleeps"],
        "attributes": {
            "os": "Ubuntu 26.04.1 / Windows 11 (dual boot)", "role": "inference",
            "node_id": "red-linux", "motherboard": "ASRock X870 Taichi Creator",
            "cpu": "Ryzen 7 9800X3D", "ram_gib": 96,
            "gpus": ["Radeon AI PRO R9700 32 GiB @ 0000:03:00.0", "Radeon AI PRO R9700 32 GiB @ 0000:06:00.0"],
            "linux_tailnet": "red-linux.tailb286a5.ts.net", "linux_tailnet_ip": "100.111.105.37",
            "windows_tailnet": "red", "windows_tailnet_ip": "100.120.162.100",
            "linux_disk": "Lexar NM1090 PRO 2 TB", "windows_disk": "Samsung 9100 PRO 4 TB",
            "model_server": "Red-Qwen3.8-27B-MXFP4", "power_policy": "manual sleep/wake; no idle timer",
        },
    },
    {
        "slug": "machine:ridge",
